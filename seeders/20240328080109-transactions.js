...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('bca_transactions', [{
      CompanyCode: "12345",
    ...
    {
      CompanyCode: "12346",
      CustomerNumber: "ABC0012300DEE",
      RequestID: "201507131507262221400000001974",
      InquiryStatus: "00",
      InquiryReason: JSON.stringify({ Indonesian: 'Sukses', English: 'Success' }),
      CustomerName: "Sihol",
      CurrencyCode: "IDR",
  ...
  down: (queryInterface, Sequelize) => {
    return queryInterface.bulkDelete('bca_transactions', null, {});
  }
};
